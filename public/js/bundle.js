...
/***/ function(module, exports, __webpack_require__) {
	...
	var FancyComponent = React.createClass({displayName: "FancyComponent",
	    ...
	    render: function() {
	        ...
	        return (
	            React.createElement("div", {className: "col-md-6 button", style: containerStyle}, 
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ServerInteractionComponent = React.createClass({displayName: "ServerInteractionComponent",
	    ...
	    loadNumber: function(callback) {
	        ...
	        // Using an arrow function here, because otherwise "this" becomes the window.
	        $.getJSON('/number', function(serverResponse)  {
	            this.setState({
